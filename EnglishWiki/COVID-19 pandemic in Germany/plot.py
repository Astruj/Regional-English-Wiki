...
ax.scatter(x[0:de_len],data[0:de_len], c='tab:green', label='german',alpha=1, edgecolors='none')
ax.scatter(x[de_len:tot_len],data[de_len:tot_len], c='tab:orange', label='english',alpha=1, edgecolors='none')


ax.legend()
ax.set_facecolor('lightpink')
#ax.grid(True)
plt.title('editors : COVID-19 pandemic in Germany')
...
ax.set_facecolor('lightpink')
#ax.grid(True)
plt.title('Pageviews - COVID-19 pandemic in Germany')
...
ax.set_facecolor('lightpink')
#ax.grid(True)
plt.title('corresponding to COVID-19 pandemic in Germany')
...
ax.scatter(x[0:de_len],ratio[0:de_len], c='tab:green', label='german',alpha=1, edgecolors='none')
ax.scatter(x[de_len:tot_len],ratio[de_len:tot_len], c='tab:orange', label='english',alpha=1, edgecolors='none')
...
ax.scatter(x[0:de_len],ratio[0:de_len], c='tab:green', label='hindi',alpha=1, edgecolors='none')
ax.scatter(x[de_len:tot_len],ratio[de_len:tot_len], c='tab:orange', label='english',alpha=1, edgecolors='none')
